<template>
  <div class="sidebar">
    ...
    <div class="section">
      <h5>
        <router-link :to="{ name: 'why-vuecore' }">Why Vuecore</router-link>
      </h5>
    </div>
    <div class="section">
      <h5>
